...
class ArbitrageExecutor {
    constructor(components) {
        this.services = [];
        this.services.push(new kraken_1.Kraken(["BTC/USDT", "XRP/USDT", "ETH/USDT"], components), new bitfinex_1.Bitfinex(['tBTCUSD', 'tETHUSD', 'tXRPUSD'], components), new poloniex_1.Poloniex(['USDT_BTC', 'USDT_ETH', 'USDT_XRP'], components), new binance_1.BinanceArbitrage(['BTCUSDT'], components));
    }
    execute() {

...
const ws = require('ws');
class Binance extends base_service_1.BaseService {
    constructor(pairs, { dbMessagesQueue }) {
        super('wss://testnet-dex.binance.org/api/ws', pairs, 'binance');
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            this.baseMsg = JSON.stringify({ method: "subscribe", topic: "ticker", symbols: this.pairs });
        });
    }
    open() {
        return __awaiter(this, void 0, void 0, function* () {
